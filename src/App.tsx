...
export default function App() {
  ...
  return (
    <div style={{
      ...
      {/* ── Main Content ── */}
      <main id="main-content" style={{ position: 'relative' }} role="main">
        <AnimatePresence mode="wait">
          {view === 'welcome' ? (
            <motion.div
              key="welcome"
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: -8 }}
              transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1] }}
              style={{ height: 'calc(100dvh - 70px)', display: 'flex', flexDirection: 'column' }}
            >
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: -8 }}
              transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1] }}
              style={{ minHeight: 'calc(100dvh - 70px)', display: 'flex', flexDirection: 'column' }}
            >
              <Suspense fallback={<LoadingFallback />}>
