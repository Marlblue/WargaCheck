    ...
    if (this.state.hasError) {
      return (
        <div style={{
          ...
          <h2 style={{ fontSize: 18, fontWeight: 700, color: '#111', margin: '0 0 8px', letterSpacing: '-0.02em' }}>
            Terjadi Kesalahan
          </h2>
          <p style={{ fontSize: 14, color: '#6B6B6B', margin: '0 0 24px', maxWidth: 360, lineHeight: 1.6 }}>
